...
- **[API.md](API.md)** -- полный справочник всех 12 функций с формулами и граничными случаями
- **Full.md** -- подробная документация (архитектура, математика, производительность)
- **test_cpp/** -- C++ тесты (примеры вызовов всех функций)
- **test_python/** -- Python тесты с визуализацией
- **Doc/plots/** -- графики ошибок дискриминаторов
